...
namespace APIVerve
{
    public class UsernameGeneratorAPIClient
    {
        ...
        public UsernameGeneratorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public UsernameGeneratorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(usernamegeneratorQueryOptions options)
        {
            try
            {
                if (_isDebug)
